...
# That OPENLANE variable doesn't seem to be set at the times I expect.

# (reset case analysis does get sensible pre-CTS STA, but makes timing worse,
# so removed. It might be useful if there was any gate resizing done prior to
# CTS, but there is not.)
